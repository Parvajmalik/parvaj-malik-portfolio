    ...
    <div>
        ...
        <div className="container">
          ...
          <div className="text-center mb-3">
            <span className="rounded-pill px-4 py-2 fw-medium fs-5 position-relative d-inline-block hello-badge">
              {hero.greeting}
              <svg width="28" height="28" className="squiggle-top" viewBox="0 0 32 33" fill="none">
                <path
                  ...
                  stroke="#FEB273" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"
                />
              </svg>
            </span>
          </div>
          ...
          <div className="text-center position-relative mb-5">
            ...
            <svg width="55" height="65" className="squiggle-headline" viewBox="0 0 74 85" fill="none">
              <path
                ...
                stroke="#FEB273" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round"
              />
            </svg>
          </div>
          ...
          <div className="row align-items-end g-4 mt-2">
            ...
            <div className="col-lg-3 col-12 d-flex justify-content-lg-end justify-content-center">
              <div className="testimonial-wrap">
                ...
                <p className="fw-medium mb-0 testimonial-text">{hero.testimonial}</p>
              </div>
            </div>
      ...
      <section className="py-5 about-section">
        <div className="container">
          ...
          <p className="text-white-50 mb-5 about-desc">{about.description}</p>

          <div className="row g-4">
            {about.skills.map((s, i) => (
              <div className="col-md-4" key={i}>
                <div className="rounded-4 p-3 h-100 position-relative about-card">
                  <h3 className="text-white fw-semibold mb-3 skill-title">{s.title}</h3>
          ...
          {workExperience.map((work, index) => (
            <div key={work.id} className="row align-items-start g-3 mb-4">
              ...
              <div className="col-5 text-end pt-2">
                <h3 className="fw-bold mb-1 work-title text-dark-custom">{work.company}</h3>
                <p className="text-secondary mb-0 small">{work.period}</p>
              </div>

              {/* Dot + connector */}
              <div className="col-2 d-flex flex-column align-items-center pt-2">
                <div className={`timeline-dot ${index === 1 ? "timeline-dot-dark" : "timeline-dot-orange"}`} />
                {index < workExperience.length - 1 && <div className="timeline-line" />}
              </div>

              {/* Right */}
              <div className="col-5 pt-2">
                <h3 className="fw-bold mb-1 work-title text-dark-custom">{work.position}</h3>
